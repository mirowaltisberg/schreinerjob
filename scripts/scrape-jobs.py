"""
Scrape Swiss carpentry/woodworking jobs using python-jobspy and output JSON.
...
def is_relevant_job(job: dict) -> bool:
    """Return True if the job belongs on a Swiss carpentry/woodworking jobs site."""
...
def normalize_job(raw: dict, idx: int) -> dict | None:
    ...
    stable_id = f"scraped-schreiner-{url_hash}"
        ...
        try:
            ...
            for job in existing:
                ...
                if url and url not in seen_urls:
                    ...
                    job["id"] = f"scraped-schreiner-{url_hash}"
