"""Shared deny-first Schreiner classifier backed by src/config/job-safety.json."""
...
def classify_schreiner_title(title_value: Any) -> dict[str, Any]:
    ...
    if not match:
        return {"disposition": "REJECT", "reason": "no-schreiner-title-signal"}
    ...
    return {
        "disposition": "ACCEPT",
        "reason": "specific-schreiner-title" if specific else "broad-role-with-schreiner-context",
