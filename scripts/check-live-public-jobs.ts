...
import { classifySchreinerTitle, validateRawJobIdentity } from "../src/lib/job-safety";
...
async function main(): Promise<void> {
  ...
  rows.forEach((row) => {
    ...
    const classification = classifySchreinerTitle(row.title);
