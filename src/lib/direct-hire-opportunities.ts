...
const CONTROLLED_ROLES = [
  { key: "schreiner-efz", role: "Schreiner/in EFZ", aliases: ["efz"] },
  { key: "moebel-innenausbau", role: "Schreiner/in Möbel und Innenausbau", aliases: ["möbel", "moebel", "innenausbau"] },
  { key: "montage", role: "Montageschreiner/in", aliases: ["montage", "montageschreiner"] },
  { key: "bankschreiner", role: "Bankschreiner/in", aliases: ["bank", "bankschreiner", "werkstatt"] },
  { key: "cnc-holz", role: "CNC-Maschinist/in Holz", aliases: ["cnc", "maschinist"] },
  { key: "avor", role: "AVOR-Projektleiter/in Schreinerei", aliases: ["avor", "arbeitsvorbereitung"] },
  { key: "kuechenmontage", role: "Küchenmonteur/in", aliases: ["küche", "kueche", "küchenmonteur"] },
  { key: "fenstermontage", role: "Fenstermonteur/in Schreinerei", aliases: ["fenster", "fenstermonteur"] },
  { key: "service", role: "Service-Schreiner/in", aliases: ["service", "reparatur"] },
  { key: "schreinerpraktiker-eba", role: "Schreinerpraktiker/in EBA", aliases: ["eba", "schreinerpraktiker"] },
  { key: "werkstattleitung", role: "Werkstattleiter/in Schreinerei", aliases: ["werkstattleiter", "werkstattleitung"] },
  { key: "projektleitung", role: "Projektleiter/in Innenausbau", aliases: ["projektleiter", "projektleitung"] },
] as const;
...
export function assertDirectHireOpportunity(value: DirectHireOpportunity): void {
  ...
  if (!value.id.startsWith("direct-hire-schreiner-") || !value.role || !value.location) {
...
export function buildDirectHireOpportunities({
  ...
  return Array.from({ length: count }, (_, index) => {
    ...
    const opportunity: DirectHireOpportunity = {
      ...
      id: `direct-hire-schreiner-${stableHash(`${seed}|${role.key}|${index}`)}`,
      role: role.role,
      location,
