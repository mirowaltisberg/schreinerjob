...
const PROJECT_TYPES = [
  "Innenausbau-Projekten",
  "Küchenprojekten",
  "Möbelfertigungen",
  "Holzbauprojekten",
  "Fensterbau-Aufträgen",
  "Renovierungsprojekten",
];

const RESPONSIBILITY_TEMPLATES = [
  "Fertigung von Möbeln und Einbauschränken nach Mass.",
  "Montage von Küchen, Schränken und Innenausbauten beim Kunden.",
  "Bedienung und Programmierung von CNC-Holzbearbeitungsmaschinen.",
  "Oberflächenbehandlung und Endmontage von Holzprodukten.",
  ...
  "Anfertigung von Werkstattzeichnungen und Massaufnahmen.",
  "Begleitung von Abnahmen und Übergaben.",
  "Holzbearbeitung an konventionellen und CNC-Maschinen.",
  "Mitarbeit bei Optimierung von Produktionsabläufen.",
];

const REQUIREMENT_TEMPLATES = [
  "Abgeschlossene Ausbildung als Schreiner EFZ oder gleichwertig.",
  "Sorgfältige und selbstständige Arbeitsweise.",
  "Teamfähigkeit und klare Kommunikation auf Deutsch.",
  "Erfahrung in Möbelbau oder Innenausbau von Vorteil.",
  "Sicherer Umgang mit Werkstattzeichnungen und Planunterlagen.",
  ...
  "Kenntnisse in Holzbearbeitung und Oberflächenbehandlung.",
...
function buildGeneratedJob(
  ...
  const focusText = primaryFocus
    ...
    : "mit Fokus auf moderne Holzprojekte";
