...
export const metadata: Metadata = {
  ...
  description:
    "Schreinerstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/schreiner-in-der-naehe" },
  openGraph: {
    title: "Schreiner in der Nähe | Jobs in deiner Stadt finden",
    description: "Schreinerstellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/schreiner-in-der-naehe",
    type: "website",
  },
  twitter: {
