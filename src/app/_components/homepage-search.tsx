...
function DirectHireOpportunityCard({ opportunity }: { opportunity: DirectHireOpportunity }) {
  ...
  return (
    <Card
      data-nosnippet
      className="job-card border-primary/35 bg-primary/[0.035] py-0 gap-0"
      role="group"
    ...
    >
      <CardContent className="p-5 pl-6 sm:p-6 sm:pl-7">
        <div className="mb-3 flex min-w-0 flex-wrap items-center gap-2">
          <h3
            id={headingId}
            className="basis-full min-w-0 text-base font-bold text-slate-900 [overflow-wrap:anywhere] sm:text-xl"
          >
            {opportunity.role}
          </h3>
        ...
        <div className="job-facts">
          ...
          <div className="job-fact sm:col-span-3">
            <span className="job-fact__value min-w-0">
              <span className="truncate">{opportunity.preferenceSummary.join(" · ")}</span>
            </span>
        ...
        <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <p className="min-w-0 flex-1 text-sm leading-relaxed text-slate-600 [overflow-wrap:anywhere]">
            {opportunity.process}
          </p>
          <Link
...
export function HomepageSearch({ initialData, initialFilters }: HomepageSearchProps) {
  ...
  const [opportunities, setOpportunities] = useState<DirectHireOpportunity[]>(
  ...
  const hasVisibleResultsRef = useRef(
    Boolean((initialData?.jobs.length ?? 0) + (initialData?.opportunities.length ?? 0)),
  );
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-5">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-foreground">
                  {hasSearched ? "Passende Schreinerstellen" : "Aktuelle Schreinerstellen"}
                </h2>
                {hasActiveLocation && (
              ...
              <span
                className="font-mono text-xs font-semibold uppercase tracking-wider text-muted-foreground [overflow-wrap:anywhere]"
                role="status"
                aria-live="polite"
              >
                  ...
                  {opportunities.length > 0 && (
                    <span>· {opportunities.length} Direktanstellungsprofile</span>
                  )}
              </span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <NativeDialog
                ...
                descriptionId="mobile-filter-description"
              >
                <div className="pr-12">
            ...
            <div>
              ...
              <NativeDialog
                ...
                titleId="mobile-sort-title"
                descriptionId="mobile-sort-description"
                compact
              >
                <div className="pr-12">
