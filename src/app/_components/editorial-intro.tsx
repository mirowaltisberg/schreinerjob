...
import type { EditorialContent } from "@/data/editorial/schreinerjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/schreinerjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Schreiner EFZ" */
  role: string;
