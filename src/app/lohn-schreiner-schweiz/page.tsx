...
export const metadata: Metadata = {
  title: "Lohn Schreiner Schweiz | GAV & Salarium",
  description:
    "Schreiner-Lohn mit offiziellen Schweizer Quellen einordnen: BFS Salarium, SECO-GAV und Lehrlingslohn-Empfehlungen.",
  alternates: { canonical: "/lohn-schreiner-schweiz" },
  openGraph: {
    title: "Lohn Schreiner Schweiz | GAV & Salarium",
    description:
      "Schreiner-Lohn mit offiziellen Schweizer Quellen einordnen: BFS Salarium, SECO-GAV und Lehrlingslohn-Empfehlungen.",
    url: "/lohn-schreiner-schweiz",
    type: "article",
  },
  twitter: {
...
const APPRENTICE_RECOMMENDATIONS = [
  { year: "1. Lehrjahr", amount: "CHF 700.– pro Monat" },
  { year: "2. Lehrjahr", amount: "CHF 1'000.– pro Monat" },
  { year: "3. Lehrjahr", amount: "CHF 1'350.– pro Monat" },
  { year: "4. Lehrjahr", amount: "CHF 1'650.– pro Monat" },
];
...
const FAQS = [
  ...
  {
    question: "Wie hoch ist der Lehrlingslohn für Schreiner EFZ?",
    answer:
      "Das am 20. August 2026 geprüfte Berufsprofil von berufsberatung.ch nennt Empfehlungen von CHF 700 im ersten, CHF 1'000 im zweiten, CHF 1'350 im dritten und CHF 1'650 im vierten Lehrjahr. Es handelt sich um Empfehlungen, nicht um eine pauschale Zusicherung für jeden Lehrvertrag.",
  },
  {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Startseite", item: SITE_URL },
    {
      "@type": "ListItem",
      position: 2,
      name: "Lohn Schreiner Schweiz",
      item: `${SITE_URL}/lohn-schreiner-schweiz`,
    },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Lohn Schreiner Schweiz: GAV und Lohnrechner",
  description:
    "Methodischer Leitfaden zur Einordnung von Lohnangaben mit offiziellen Schweizer Quellen.",
  datePublished: "2026-08-19",
  dateModified: "2026-08-20",
  author: { "@type": "Organization", name: "Redaktion schreinerjob.ch" },
  publisher: {
    "@type": "Organization",
  ...
  return (
    <>
      ...
      <main id="main-content" className="bg-background">
        <section className="trade-hero">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            ...
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Lohn als <span className="text-primary">Schreiner</span> einordnen
            </h1>
          ...
          <div className="space-y-4">
            ...
            <article className="trade-panel p-5">
              ...
              <p className="text-slate-600 leading-relaxed mb-3">
                ...
                für jede Schreinerstelle separat geprüft werden.
              </p>
              <a
            ...
            <article className="trade-panel p-5">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                Fehlende Angaben werden auf schreinerjob.ch nicht geschätzt.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className="editorial-surface border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
            ...
            <p className="text-slate-600 mb-5">
              ...
              monatlichen Empfehlungen für Schreiner EFZ. Diese
            ...
            >
              Quelle: Berufsprofil Schreiner EFZ
            </a>
          </div>
        </section>
        ...
        <SalaryOrientationCalculator profession="Schreiner" />
      </main>
