...
const homepageMetadata: Metadata = {
  ...
  description:
    "Finde Stellenangebote für Schreiner EFZ, Montage, Möbelbau, CNC, AVOR und Projektleitung Schreinerei in der Schweiz.",
    ...
    <>
      ...
      <div className="flex min-h-screen flex-col overflow-x-clip">
        <header className="trade-header sticky top-0 z-30 border-b">
          <div className="container mx-auto flex h-16 items-center justify-between gap-2 px-4 sm:h-[4.5rem] sm:px-6">
            ...
            <nav aria-label="Hauptnavigation" className="flex shrink-0 items-center gap-1 sm:gap-2">
              ...
              <Link
                href="/arbeitgeber/preise"
                prefetch={false}
                className="btn-interactive inline-flex h-11 items-center justify-center rounded-md border border-primary/35 bg-transparent px-2.5 text-xs font-medium outline-none hover:bg-accent focus-visible:ring-[3px] focus-visible:ring-ring/50 sm:px-4 sm:text-sm"
              >
        ...
        <main id="main-content" className="flex-1">
          <section
            className={`trade-hero relative z-20 overflow-visible ${hasActiveSearch
              ? "pb-5 pt-8 sm:pb-7 sm:pt-10 md:pt-12"
              : "pb-6 pt-10 sm:pb-9 sm:pt-14 md:pt-20"
            }`}
          >
            <div className="container mx-auto max-w-6xl px-4 sm:px-6">
              <div className="trade-hero-grid">
                <div>
                  <p className="trade-kicker">Schreiner · ganze Schweiz</p>
                  <h1 className="trade-display">
                    Schreinerjobs.
                    <em>Passgenau sortiert.</em>
                  </h1>
                  <p className="mt-5 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-lg">
                    Stelleninserate für Werkstatt, Möbelbau, Innenausbau, Montage, CNC und AVOR. Klar filtern nach Beruf, Ort und Pensum.
                  </p>
                </div>
                <div className="joinery-drawing" aria-hidden="true">
                  <span className="joinery-drawing__label">Verbindung 04 / Suchraster CH</span>
                </div>
              </div>
                ...
                <div className="search-bench min-w-0">
                  ...
                  <div className="search-field relative flex-1">
                    ...
                    <input
                      ...
                      name="loc"
                      type="search"
                      list="homepage-location-suggestions"
                      maxLength={80}
                      defaultValue={filters.loc}
                  ...
                  <button
                    type="submit"
                    className="btn-interactive inline-flex h-12 w-full items-center justify-center bg-primary px-6 text-base font-bold text-primary-foreground hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 md:w-auto sm:px-8"
                  >
                    Jobs suchen
                  </button>
                </div>
