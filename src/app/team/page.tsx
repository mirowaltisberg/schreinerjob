...
export const metadata: Metadata = {
  title: "Über die Redaktion | schreinerjob.ch",
  description:
    "Wer hinter den redaktionellen Inhalten von schreinerjob.ch steht: Recherche, Quellen, Methodik und unser Anspruch an Schweizer Lohn- und Branchendaten.",
  alternates: {
    canonical: "/team",
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="border-b header-blur sticky top-0 z-30">
        <div className="container mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2">
          <Link href="/" className="flex items-center shrink-0">
            <Image
              src="/logo.svg"
              alt="schreinerjob.ch — Schreinerjobs in der Schweiz"
              width={142}
              height={29}
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        ...
        <p className="text-slate-600 mt-3 text-base sm:text-lg leading-relaxed">
          Die Redaktion von schreinerjob.ch erstellt redaktionelle Inhalte zu Berufen,
          Löhnen und regionalen Arbeitsmärkten in der Schweizer Schreinerei und
          im Holzbau.
        </p>
        ...
        <section className="mt-10 space-y-6">
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              Stellenanzeigen aus der Schweizer Schreinerei und dem Holzbau und
              sollen Berufsleuten eine schnelle, ehrliche Standortbestimmung
              ermöglichen.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              der Schweizer Schreiner- und Holzbaubranche — insbesondere{" "}
              <a
              ...
              Stellenausschreibungen aus, die auf schreinerjob.ch indexiert sind.
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Inserate werden auf schreinerjob.ch grundsätzlich anonymisiert
