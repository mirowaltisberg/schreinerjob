...
export const metadata: Metadata = {
  title: "Schreiner Ausbildung Schweiz | EFZ & EBA",
  description:
    "Offizielle Grundlagen zur Ausbildung Schreiner EFZ und Schreinerpraktiker/in EBA in der Schweiz.",
  alternates: { canonical: "/schreiner-ausbildung" },
  openGraph: {
    title: "Schreiner Ausbildung Schweiz | EFZ & EBA",
    description:
      "Offizielle Grundlagen zur Ausbildung Schreiner EFZ und Schreinerpraktiker/in EBA in der Schweiz.",
    url: "/schreiner-ausbildung",
    type: "article",
  },
  twitter: {
...
const FAQS = [
  {
    question: "Wie lange dauert die Lehre Schreiner EFZ?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Laut Berufsprofil findet die praktische Ausbildung in einem Schreinerbetrieb oder einem gemischten Betrieb statt. Genannt werden vier Tage pro Woche im Betrieb, ein Tag pro Woche an der Berufsfachschule sowie überbetriebliche Kurse. Die konkrete Organisation kann kantonal und betrieblich ausgestaltet sein.",
  },
  {
    question: "Gibt es eine EBA-Ausbildung im Schreinerbereich?",
    answer:
      "Ja. Das offizielle Profil Schreinerpraktiker/in EBA nennt eine zweijährige Grundbildung. Nach dem EBA ist in der Regel eine verkürzte Lehre als Schreiner EFZ möglich; die konkrete Anrechnung ist mit der zuständigen Stelle zu klären.",
  },
  {
    question: "Welche Weiterbildungen nennt das offizielle Berufsprofil?",
    answer:
      "berufsberatung.ch nennt unter anderem Projektleiter/in und Produktionsleiter/in Schreinerei BP, Schreinermeister/in HFP sowie Holztechniker/in HF Schreinerei/Innenausbau. Der VSSM publiziert Bildungsgrundlagen; für jeden Weg gelten eigene Zulassungsbedingungen.",
  },
  {
    question: "Wo finde ich Lehrstellen?",
    answer:
      "Die offizielle Lehrstellensuche von berufsberatung.ch listet Lehrstellen nach Beruf und Region. Zusätzlich können Lehrbetriebe eigene Ausschreibungen publizieren. schreinerjob.ch verspricht keine vollständige Lehrstellenabdeckung.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Startseite", item: SITE_URL },
    {
      "@type": "ListItem",
      position: 2,
      name: "Schreiner Ausbildung",
      item: `${SITE_URL}/schreiner-ausbildung`,
    },
  ],
};
      ...
      <main id="main-content" className="bg-background">
        <section className="trade-hero">
          <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-4xl">
            ...
            <h1 className="text-3xl sm:text-5xl font-black text-slate-900 leading-tight mb-4">
              Ausbildung <span className="text-primary">Schreiner EFZ</span>
            </h1>
            <p className="text-slate-600 text-lg leading-relaxed max-w-3xl">
              Dauer, Organisation und Anschlusswege auf Basis offizieller
              Schweizer Berufsbildungsquellen.
            </p>
            <p className="mt-4 text-sm text-muted-foreground">Quellen geprüft am {REVIEW_DATE}.</p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
          ...
          <p className="text-slate-600 mb-3 leading-relaxed">
            Die berufliche Grundbildung Schreiner EFZ dauert vier
          ...
          <a
            href="https://www.berufsberatung.ch/de/berufe/schreiner-in-efz"
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary underline"
          >
            Quelle: berufsberatung.ch – Schreiner EFZ
          </a>
        </section>
        ...
        <section className="editorial-surface border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
            ...
            <p className="text-slate-600 mb-3 leading-relaxed">
              Die Grundbildung Schreinerpraktiker/in EBA dauert zwei Jahre. Nach
              dem Abschluss ist laut offiziellem Berufsprofil in der Regel eine
              verkürzte Lehre als Schreiner EFZ möglich. Ob und wie
              eine Verkürzung im Einzelfall erfolgt, klären Lernende mit der
              zuständigen Berufsbildungsstelle.
            </p>
            <a
              href="https://www.berufsberatung.ch/de/berufe/schreinerpraktiker-in-eba"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary underline"
            >
              Quelle: berufsberatung.ch – Schreinerpraktiker/in EBA
            </a>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
          ...
          <ul className="space-y-3 text-slate-700 mb-5">
            <li className="trade-panel p-4">
              <strong className="text-slate-900">Kurse und Bildungsgrundlagen</strong> — Angebote und Dokumente des VSSM; Inhalt und Zulassung unterscheiden sich je nach Angebot.
            </li>
            <li className="trade-panel p-4">
              <strong className="text-slate-900">Berufsprüfungen</strong> — Projektleiter/in und Produktionsleiter/in Schreinerei BP gemäss offiziellem Berufsprofil.
            </li>
            <li className="trade-panel p-4">
              <strong className="text-slate-900">Höhere Fachprüfung</strong> — Schreinermeister/in HFP gemäss offiziellem Berufsprofil.
            </li>
          </ul>
          <a
            href="https://www.vssm.ch/de/berufsbildung/schreinerin-efz"
            target="_blank"
            rel="noopener noreferrer"
            className="text-primary underline"
          >
            Bildungsgrundlagen des VSSM
          </a>
        </section>
        ...
        <section className="editorial-surface border-y">
          <div className="container mx-auto px-4 sm:px-6 py-10 max-w-4xl">
            ...
            <p className="text-slate-600 leading-relaxed mb-3">
              ...
              Empfehlungen von CHF 700 im ersten, CHF 1’000 im zweiten, CHF
              1’350 im dritten und CHF 1’650 im vierten Lehrjahr. Das sind
              Empfehlungen und keine Zusicherung für jeden Lehrvertrag.
            </p>
            <Link href="/lohn-schreiner-schweiz" className="text-primary underline">
